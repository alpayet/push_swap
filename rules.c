...
/*   Updated: 2025/01/31 20:56:10 by alpayet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		int print_or_not)
{
	...
	{
		temp = (*stack_b)->next;
		stack_addfront(stack_a, *stack_b);
		*stack_b = temp;
	}
	if (pa_pb[1] == 'b' && *stack_a != NULL)
	{
		temp = (*stack_a)->next;
		stack_addfront(stack_b, *stack_a);
		*stack_a = temp;
	}
	if (print_or_not == 1)
		...
		int print_or_not)
{
	...
	if ((ra_rb_rr[2] == 'a' || ra_rb_rr[2] == 'r') && (*stack_a)->next != NULL)
	{
		...
		while (temp->next->next != NULL)
			temp = temp->next;
		stack_addfront(&first, stack_last(*stack_a));
		temp->next = NULL;
		*stack_a = first;
	}
	if ((ra_rb_rr[2] == 'b' || ra_rb_rr[2] == 'r') && (*stack_b)->next != NULL)
	{
		...
		while (temp->next->next != NULL)
			temp = temp->next;
		stack_addfront(&first, stack_last(*stack_b));
		temp->next = NULL;
		*stack_b = first;
	}
	if (print_or_not == 1)
